...
public class subsetSum {
    public static void main(String[] args) {
        int output = subsetSum_f(new int[]{1, 8, 3, 15}, 10);
        System.out.println(output); // --> 9 (= 1 + 8)

        output = subsetSum_f(new int[]{20, 80, 99, 27, 35}, 100);
        System.out.println(output); // --> 100 (= 20 + 80)

        output = subsetSum_f(new int[]{10, 20, 15, 25, 30}, 5);
        System.out.println(output); // --> 0
    }

    public static int subsetSum_f(int[] set, int bound) {
        int max = 0;
