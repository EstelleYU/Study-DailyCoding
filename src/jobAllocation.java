/* -------------------------------
58_jobAllocation
Tuesday, December thirteenth 2022
...
//        int[] jobs = new int[]{ };
//        int workersNum1 = ;
//        int output1 = solution(jobs, workersNum);
//        System.out.println(output);

        int[] jobs1 = new int[]{1, 2, 3, 4, 5, 6, 7};
        int workersNum1 = 3;
        int output1 = solution(jobs1, workersNum1);
        System.out.println(output1); // --> 11 (1, 2, 3, 4 / 5, 6 / 7)

        int[] jobs2 = new int[]{10, 2, 3, 4, 16, 10, 10};
        int workersNum2 = 4;
        int output2 = solution(jobs2, workersNum2);
        System.out.println(output2); // --> 19 (10, 2, 3, 4 / 16 / 10 / 10
    }
    ...
    public static int solution(int[] jobs, int workersNum){
