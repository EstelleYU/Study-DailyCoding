...
------------------------------------
The ugly number is a number that is divisible only by 2, 3 and 5.
1 is the first ugly number. and ugly number are 1, 2, 3, 4, 5, 6, 8, 9, 10, 12, 15, 16, ...
...
public class uglyNumbers {
    public static void main(String[] args) {
        int result = uglyNumbers_f(1);
        System.out.println(result); // --> 1

        result = uglyNumbers_f(10);
        System.out.println(result); // --> 12

        result = uglyNumbers_f(30);
        System.out.println(result); // --> 80
    }
    public static int uglyNumbers_f(int n) {
